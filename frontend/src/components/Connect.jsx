                    ...
                    <div className="w-full lg:w-2/5 flex flex-col justify-center gap-8 animate-[fadeInUp_0.6s_ease-out_both_0.3s]">
                        ...
                        <div className="flex items-start gap-4 p-6 rounded-2xl bg-white/5 border border-white/5 hover:border-white/10 transition-colors backdrop-blur-sm">
                            ...
                            <div>
                                ...
                                <a href="mailto:hello@prv.com" className="text-white/60 hover:text-[#fd5108] transition-colors text-sm">hello@prv.com</a>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {/* LinkedIn */}
                            <a href="#" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-3 p-6 rounded-2xl bg-white/5 border border-white/5 hover:border-[#fd5108]/30 hover:bg-white/10 transition-all duration-300 group hover:-translate-y-1">
                            ...
                            {/* Discord */}
                            <a href="#" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-3 p-6 rounded-2xl bg-white/5 border border-white/5 hover:border-[#fd5108]/30 hover:bg-white/10 transition-all duration-300 group hover:-translate-y-1 col-span-2">
                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-white/50 group-hover:text-white transition-colors">
