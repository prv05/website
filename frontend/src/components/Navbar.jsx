    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-50 bg-transparent font-sans box-border px-10 py-5 max-md:p-5 max-lg:px-5 pointer-events-none">
            <div className="w-full max-w-6xl flex justify-between items-center mx-auto pointer-events-auto">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="hidden md:flex items-center bg-white/5 backdrop-blur-2xl px-[30px] h-[54px] rounded-[50px] border border-white/20 gap-[30px] shadow-[0_0_30px_rgba(255,255,255,0.05)]">
                        ...
                        <Link to="/projects" className={navLinkClasses('projects', '/projects')}>Projects</Link>
            ...
            <div className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-[400px] h-[60px] bg-[#141414]/90 backdrop-blur-xl border border-white/10 rounded-full flex items-center justify-between px-6 shadow-[0_10px_30px_rgba(0,0,0,0.5)] z-50 pointer-events-auto">
                ...
                <Link to="/skills" className={`flex flex-col items-center justify-center transition-colors duration-300 ${isActive('skills', '/skills') ? 'text-white' : 'text-white/40 hover:text-white/80'}`}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5 sm:w-6 sm:h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.83-5.83M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                    </svg>
                </Link>

                <Link to="/projects" className={`flex flex-col items-center justify-center transition-colors duration-300 ${isActive('projects', '/projects') ? 'text-white' : 'text-white/40 hover:text-white/80'}`}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5 sm:w-6 sm:h-6">
